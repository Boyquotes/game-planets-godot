...
static func edge_tile_northern_hem_left(map_size, section_size, section_column, x_in, y_in):
	...
	x_out = x_out - section_size if x_in % section_size == 1 && y_in % section_size == 0 else x_out
