...
static func edge_tile_southern_hem_left(map_size, section_size, x_in, y_in, map_array, out_of_map_bounds_redirect):
	...
	x_out = out_of_map_bounds_redirect.out_of_map_bounds_redirect(x_out, map_array)
